...
export default function IncomeSimPage() {
  return (
    <>
      <Navbar />
      <main className="flex-1 flex flex-col items-center justify-center p-4">
        <div className="mx-auto max-w-md w-full space-y-6 rounded-2xl border-2 border-dashed border-primary/20 bg-muted/10 p-12 text-center">
          ...
          <h2 className="text-3xl font-bold font-headline uppercase">Income Simulator Under Construction</h2>
          <p className="text-muted-foreground">The economy is being calibrated. Please check back later!</p>
          <Link href="/">
